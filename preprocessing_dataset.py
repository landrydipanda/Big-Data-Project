...
if __name__=="__main__":   
    ...
    print("La moyenne des mots par articles est : "+str(mean(list_nb_wds)))
    print("\nAffichage du nombre d'articles par categorie\n")
    print("Categorie"+'\t'+"Nb articles dans la categorie\t"+"Moyenne des mots par article dans cette categorie")
