...
def lemmatisation_and_pos_tagging(doc):#doc : article de type 'str'
    ...
    #plus d'information : https://medium.com/@gianpaul.r/tokenization-and-parts-of-speech-pos-tagging-in-pythons-nltk-library-2d30f70af13b
...
#Extraction d'une liste de mots discriminant representant chaque categorie : utilisation de la metrique tf-idf
